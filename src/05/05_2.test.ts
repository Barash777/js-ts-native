...
import {createMessages, getStreetsTitlesOfGovernmentsBuildings, getStreetsTitlesOfHouses} from './05_2';
...
// ----
test('list of streets of governments buildings', () => {
...
test('list of streets of houses', () => {
