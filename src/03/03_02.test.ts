...
test('greeting message for the city', () => {
    const message = getGreetingMessageForTheCity(city)

    expect(message).toBe('Hello Chicago citizens, all 1000000 men!')
})