...
import {demolishHousesOnTheStreet, demolishHousesOnTheStreet2, getBuildingsWithStaffCountGreaterThan} from './04_2';
...
test('House should be destroyed', () => {
    ...
    const newCity = demolishHousesOnTheStreet2(city, 'Happy street');
    expect(newCity.length).toBe(1);
    expect(newCity[0].id).toBe(1);
    // expect(newCity)
